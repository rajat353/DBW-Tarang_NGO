...
<link rel='stylesheet' href='new21.css'>
</head>
...
$con    = Connect();
$sql="select * from review order by date desc limit 3";
$result=$con->query($sql);
echo " <h3>What people are saying about us</h3><style>h3{text-align: center; font-family: sans-serif; text-transform: uppercase;}</style>";
...
echo "<div class='item'>
	  ...
	  <div class='email'>$email</div><div> $date</div></div>
      <div class='quote'>
        <p>$message</p>
      </div>
    </div> ";
